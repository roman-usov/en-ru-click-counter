...
test('i18n', async () => {
  ...
  await userEvent.default.click(screen.getByRole('button', { name: /русский/i }));
  ...
  await userEvent.default.click(screen.getByRole('button', { name: /english/i }));
  expect(await screen.findByRole('button', { name: /0 clicks/i })).toBeInTheDocument();
  expect(screen.getByRole('button', { name: /reset/i })).toBeInTheDocument();
});

test('plurals', async () => {
  await userEvent.default.click(screen.getByRole('button', { name: /0 clicks/i }));
  expect(screen.getByRole('button', { name: /1 click/i })).toBeInTheDocument();
  await userEvent.default.click(screen.getByRole('button', { name: /1 click/i }));
  ...
  await userEvent.default.click(screen.getByRole('button', { name: /2 клика/i }));
  await userEvent.default.click(screen.getByRole('button', { name: /3 клика/i }));
  await userEvent.default.click(screen.getByRole('button', { name: /4 клика/i }));
  await userEvent.default.click(screen.getByRole('button', { name: /5 кликов/i }));
  await userEvent.default.click(screen.getByRole('button', { name: /сбросить/i }));
  await userEvent.default.click(screen.getByRole('button', { name: /0 кликов/i }));
